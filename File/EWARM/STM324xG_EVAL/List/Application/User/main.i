...
int main(void)
{
	...
	{  
        ...
        if((mLed_Process_Flag.sEth_Rx_Finish_TimeCnt) == 1) 
        {
            ...
            if(mLed_Process_Flag.sEth_Rx_Request_Flag) 
            {
...
static void BSP_Config(void)
{
	...
	do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (7U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (7U)))); ((void)(tmpreg)); } while(0U);
	...
	HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), &GPIO_InitStructure);

    
    
	IP_ADDR1_INPUT_DATA =  HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), ((uint16_t)0x0100));  
	IP_ADDR1_INPUT_DATA |= HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), ((uint16_t)0x0200))  << 1;
	IP_ADDR1_INPUT_DATA |= HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), ((uint16_t)0x0400)) << 2;
	IP_ADDR1_INPUT_DATA |= HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), ((uint16_t)0x0800)) << 3;
    
	IP_ADDR1_INPUT_DATA = ((~IP_ADDR1_INPUT_DATA) & 0x0F);
    
    
	IP_ADDR2_INPUT_DATA = HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), ((uint16_t)0x1000));
	IP_ADDR2_INPUT_DATA |= HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), ((uint16_t)0x2000)) << 1;
	IP_ADDR2_INPUT_DATA |= HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), ((uint16_t)0x4000)) << 2;
	IP_ADDR2_INPUT_DATA |= HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), ((uint16_t)0x8000)) << 3;
	...
	GPIO_InitStructure.Pin = ((uint16_t)0x4000) | ((uint16_t)0x8000);
	GPIO_InitStructure.Pull = 0x00000000U;
	GPIO_InitStructure.Mode = 0x00000001U;
	HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), &GPIO_InitStructure);
    
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x4000), GPIO_PIN_RESET);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x8000), GPIO_PIN_RESET);
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0001), GPIO_PIN_SET);
	...
	do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (3U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (3U)))); ((void)(tmpreg)); } while(0U);
	GPIO_InitStructure.Pin = ((uint16_t)0x0004) | ((uint16_t)0x0008) | ((uint16_t)0x0010);
	GPIO_InitStructure.Pull = 0x00000001U;
	GPIO_InitStructure.Mode = 0x00000000U;  
	GPIO_InitStructure.Speed = 0x00000003U;
	HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), &GPIO_InitStructure);
	...
	GPIO_InitStructure.Pin = ((uint16_t)0x0400) | ((uint16_t)0x0800) | ((uint16_t)0x1000) | ((uint16_t)0x2000) | ((uint16_t)0x4000);
	GPIO_InitStructure.Pull = 0x00000001U;
	GPIO_InitStructure.Mode = 0x00000000U;  
	GPIO_InitStructure.Speed = 0x00000003U;
	...
	GPIO_InitStructure.Pull = 0x00000000U;
	GPIO_InitStructure.Mode = 0x00000003U;  
