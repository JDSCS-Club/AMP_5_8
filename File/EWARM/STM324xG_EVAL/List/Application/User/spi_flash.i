...
void SPI_FLASH_Main(void)
{
	...
	if((mSPI_Time_Cnt==5000))
	{
		...
		if((0x14016&0xFFFF) == (SPI_FLASH_ID&0xFFFF))
		{
			...
			SPI_FLASH_BufferWrite(SPI_Tx_Buffer, sSpi_Mermory_Address, sizeof(SPI_Tx_Buffer));  
	
            HAL_Delay(10);
            
			SPI_FLASH_BufferRead(SPI_Rx_Buffer, sSpi_Mermory_Address, sizeof(SPI_Tx_Buffer));  
