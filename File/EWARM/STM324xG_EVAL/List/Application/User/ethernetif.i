...
{ 
  ...
  GPIO_InitStructure.Pin = ((uint16_t)0x0002) | ((uint16_t)0x0004) | ((uint16_t)0x0080);
  ...
  GPIO_InitStructure.Pin = ((uint16_t)0x0020) | ((uint16_t)0x0100);
  ...
  GPIO_InitStructure.Pin =  ((uint16_t)0x0800) | ((uint16_t)0x2000) | ((uint16_t)0x4000);
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1800U)), &GPIO_InitStructure);

   
  GPIO_InitStructure.Pin = ((uint16_t)0x0004) | ((uint16_t)0x0008) | ((uint16_t)0x0040) | ((uint16_t)0x0080);
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1C00U)), &GPIO_InitStructure);

   
  GPIO_InitStructure.Pin = ((uint16_t)0x0400);
  ...
  if (heth->Init.MediaInterface == 0x00000000U)
  {
     
    HAL_RCC_MCOConfig(0x00000000U, (0x2U << (21U)), 0x00000000U);
  }
}
